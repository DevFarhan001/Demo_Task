...
import 'package:demo_test/screens/item_screen.dart';
import 'package:demo_test/screens/login_screens.dart';
...
Future<void> main()async {
  ...
  SharedprefernceHelper.prefs = await SharedPreferences.getInstance();
  runApp(const MyApp());
}
